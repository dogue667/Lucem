   ...
   <!-- DARK MODE CSS -->
    ...
    <style>
        ...
        header {
            ...
            display: flex;
            justify-content: space-between; /* AQUI CENTRALIZA TUDO */
            align-items: center;
            padding: 18px 40px;
        ...
        .header-container {
    max-width: 1400px;      /* controla tudo */
    ...
    align-items: center;
        ...
        .logo {
            ...
            letter-spacing: 1px;
            margin-right: 0 !important; /* NÃO FORÇA O MENU PARA O LADO */
        }

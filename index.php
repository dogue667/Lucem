...
<body>
    ...
    <section class="inicio fade">
        ...
        <p>
            Seu espaço de equilíbrio e autocuidado.<br>
            Cuide da mente, respire fundo e comece hoje.
        </p>
    ...
    <section class="sobre fade">
        ...
        <p>
            O LUCEM é um espaço digital criado para ajudar pessoas a acompanharem suas emoções, encontrarem apoio
            psicológico acessível e aprenderem sobre saúde mental de forma leve e acolhedora.
    ...
    <section class="saude fade">
        ...
        <p>
            Cuidar da mente é um ato de amor-próprio. A saúde mental é a base para viver com leveza,
            resiliência e bem-estar. O LUCEM foi criado para te acompanhar nessa jornada —
            passo a passo, com empatia, ciência e acolhimento.
        </p>
    </section>
    ...
    <section class="seguranca fade">
        ...
        <p>
            No LUCEM, a sua privacidade é prioridade. Todos os seus registros emocionais e informações
            pessoais são armazenados de forma segura e confidencial.
        </p>
